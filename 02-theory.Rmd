...
(see Figure [1](#fig:modistheory1){reference-type="ref"
reference="fig:modistheory1"}). A large set of behaviours have been
...
[2](#fig:modistheory2){reference-type="ref"
reference="fig:modistheory2"} [@Modis2013-to]. In Bach's time
...
Figure [3](#fig:modistheory3){reference-type="ref"
reference="fig:modistheory3"} [@Modis2007-ur]. On the other hand, if
...
scaled error (MASE), mean absolute percentage error (MAPE) or many
others [see section 3.4 in @hyndman2018Forecasting_CB]. Which one is
most appropriate for our situation, or should we even use multiple
different PFEMs?

There are many common point forecast error measures (PFEMs), e.g., the
MSE, MAE, MASE, (s)MAPE, the quantile score or pinball loss or many
others [e.g., sections 5.8 and 5.9 in @HyndmanAthanasopoulos2021-09-27].
...
$$\begin{gathered}
    ...
    Q_\alpha = \sum_{t=n+1}^{n+H}(1-\alpha)(f_t-y_t)1_{y_t<f_t} + \alpha(y_t-f_t)1_{y_t \geq f_t}.\end{gathered}$$
...
-   In general, there is no loss function that is minimised by the mode
    [@Heinrich2014_SK].
